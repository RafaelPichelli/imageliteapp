...
export const Template: React.FC<TemplateProps> = ({ children, loading, authenticated }: TemplateProps) => {
    return (
        <>
...
const Header: React.FC<HeaderProps> = ({authenticated}) => {
    ...
    if(authenticated){
        userName = auth.getUserSession()?.name || "";
    }
    ...
    return (
        <header className="bg-indigo-950 text-white py-3">
            <div className="container mx-auto flex justify-between items-center px-4">
                <Link href="/galeria">
                    <h1 className="text-5xl font-bold">ImageLite</h1>
                </Link>
                <RenderIf condition={authenticated}>
                    <div className="flex items-center">
                        <div className="relative">
                            ...
                            <span className="w-64 py-3 px-6 text-sm">
                                <a href="#" onClick={logout} className="hover:bg-red-300">
                                    Sair
                                </a>
                            </span>
                        </div>
    ...
    return (
        <footer className="bg-indigo-950 text-white py-4 mt-8">
            <div className="container mx-auto text-center">
                Desenvolvido por Rafael Pichelli
            </div>
        </footer>
    )
}
